...
import { ProfileItem, Language } from '../types';
    ...
    <div className="max-w-5xl mx-auto px-4 md:px-6 py-12 md:py-20 animate-in fade-in duration-700">
      ...
      <div className="space-y-8 md:space-y-12">
        <header className="space-y-4 text-left">
          ...
          <p className="text-lg md:text-2xl text-zinc-400 font-light border-l-2 border-yellow-500/50 pl-6 italic">
            {subtitle}
          </p>
        </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 text-left pt-12 border-t border-white/5">
          <div className="lg:col-span-8 space-y-12">
            <div 
              className="text-zinc-300 leading-relaxed font-light text-lg md:text-xl prose prose-invert prose-yellow max-w-none"
          ...
          <aside className="lg:col-span-4 hidden lg:block">
            <div className="sticky top-32 p-8 rounded-3xl bg-zinc-900/40 border border-white/5 text-[10px] uppercase tracking-widest text-zinc-600">
              Details for professional review.
            </div>
          </aside>
        </div>
      </div>
